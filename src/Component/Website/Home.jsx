        ...
        <div className="container position-relative">
          ...
          <div className="row g-4">
                    ...
                    {plans.map((plan, index) => (
                      ...
                      {plan.description.map((point, i) => (
                        <li key={i} className="mb-3">
                          <i className={`fas fa-check me-2 ${index === 1 ? "text-white" : "text-success"}`}></i>
                          {point}
                        </li>
                      ))}
                    </ul> */}
            ...
            {/* <div className="col-12 col-md-4">
              ...
              >
                ...
                <div className="text-center position-relative text-white">
                  ...
                  <ul className="text-start mb-4 list-unstyled">
                    <li className="mb-3">
                      <i className="fas fa-check text-white me-2"></i>Up to
                      5,000 orders/month
                    </li>
                    <li className="mb-3">
                      <i className="fas fa-check text-white me-2"></i>5 User
                      Access
                    </li>
                    <li className="mb-3">
                      <i className="fas fa-check text-white me-2"></i>All Core +
                      Reports
                    </li>
                    <li className="mb-3">
            ...
            {/* <div className="col-12 col-md-4">
              ...
              >
                <div className="text-center position-relative">
                  <h3 className="text-dark fs-3 fw-bold mb-3">
                    Pro / Enterprise
                  </h3>
                  <div className="mb-4">
                    <div className="d-flex align-items-center justify-content-center">
                  ...
                  <ul className="text-start mb-4 list-unstyled">
                    ...
                    <li className="mb-3">
                      <i className="fas fa-check text-success me-2"></i>Custom
                      Integrations
                    </li>
                    <li className="mb-3">
                      <i className="fas fa-check text-success me-2"></i>
